...
class InterestsManager {
	...
	function addInterests($add_interest){
	...
	function getUserInterests(){
		...
		$stmt = $this->connection->prepare("SELECT interests.name FROM user_interests INNER JOIN interests ON 
		user_interests.interests_id = interests.id WHERE user_interests.user_id = ?");
		$stmt->bind_param("i", $this->user_id);
